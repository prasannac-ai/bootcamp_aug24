...
// when(userService.updateUser(eq(userId),
// any(Users.class))).thenReturn(updatedUser);
...
// Server")).when(userService).deleteUser(userId);
...
// found")).when(userService).updateUser(any(UUID.class),
// any(Users.class));

// mockMvc.perform(put("/api/v1/users/{id}",
// userid).contentType(MediaType.APPLICATION_JSON)
// .content("{\"name\":\"John Updated\"," +
// "\"email\":\"john.updated@example.com\"," +
// "\"role\":\"Admin\"," +
// "\"mobile\":\"1234567890\"," +
